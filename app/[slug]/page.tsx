...
const pages: Record<string, { key: PageKey; title: string; description: string }> = {
  about: { key: "about", title: "About the Clinic", description: "Discover the EvoDentist philosophy: exceptional clinical standards, thoughtful hospitality, and care designed around you." },
  dentists: { key: "dentists", title: "Meet the Dentists", description: "Meet EvoDentist’s experienced orthodontic, implant, cosmetic, family, and pediatric dental clinicians." },
  ...
  testimonials: { key: "testimonials", title: "Patient Testimonials", description: "Read verified patient stories about the comfort, clarity, expertise, and results experienced at EvoDentist." },
  ...
  contact: { key: "contact", title: "Contact the Clinic", description: "Contact EvoDentist in Hydra, Algiers. Call, message, get directions, or request an appointment." },
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: `${page.title} | EvoDentist`, description: page.description, url: `/${slug}` },
  };
}
